...
r                 @[justify|justify.sed]@ [@[colored|@local/scripts/justify.sed.html]@] by Aurelio Jargas
...
r    @[yahoogroups-kill-sig|yahoogroups-kill-sig.sed]@ [@[colored|@local/scripts/yahoogroups-kill-sig.sed.html]@] by Aurelio Jargas
}
